...
export default defineConfig({
  ...
  resolve: {
    alias: [
      ...
      { find: "@/lib/db", replacement: path.resolve(import.meta.dirname, "standalone/stubs/db.ts") },
      { find: "@/lib/offline-store", replacement: path.resolve(import.meta.dirname, "standalone/stubs/db.ts") },
      { find: "@/integrations/supabase/client", replacement: path.resolve(import.meta.dirname, "standalone/stubs/supabase-client.ts") },
      { find: "@/components/sync-indicator", replacement: path.resolve(import.meta.dirname, "standalone/stubs/sync-indicator.tsx") },
